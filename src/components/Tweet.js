...
const Tweet = ({like, reply, loading, status}) => {
	if(loading){
	...
	return <div className="tweet">
		<div className="tweet-head">
			...
			<div className="tweet-author">
				<div className="name">
					<a href={`https://twitter.com/${status.user.screen_name}`}>{status.user.name}</a>
				...
				<div className="handle"><a href={`https://twitter.com/${status.user.screen_name}`}>@{status.user.screen_name}</a></div>
			</div>
		...
		<div className="tweet-footer">
			 <div className="icons">
				 ...
				 <i onClick={like} className="fas fa-heart"> <span className="like-count">{status.favorite_count}</span></i>
			 </div>
			 <div className="timestamp">
					<a href={`https://twitter.com/${status.user.screen_name}/${status.id_str}`}>
